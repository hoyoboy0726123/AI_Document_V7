...
OUT = r"C:\Users\G635LXG\Downloads\RAG\RAG到知識圖譜_技術匯報_完整版.pptx"
...
# +A · 向量與語意白話
s = newslide("PART 1 · 什麼是 RAG", "向量與語意:AI 怎麼知道兩句話「意思相近」")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.6),
     [[("關鍵技術叫「向量化」(Embedding):把每句文字轉成一組座標。意思越接近,座標距離越近。", 15.5, False, DARK)]])
box(s, Inches(0.7), Inches(2.25), Inches(7.6), Inches(4.3), fill=BG, line=LGRAY)
text(s, Inches(0.9), Inches(2.35), Inches(5), Inches(0.4), [[("語意空間(示意):同義的擠在一起,不同主題自然分開", 13.5, True, NAVY)]])
clu = [("濕度", 1.7, 3.35, BLUE), ("humidity", 2.9, 3.05, BLUE), ("moisture", 2.3, 3.95, BLUE), ("潮濕環境", 1.5, 4.35, BLUE),
       ("鹽霧", 5.9, 3.2, GREEN), ("salt fog", 6.9, 3.55, GREEN), ("腐蝕", 6.2, 4.15, GREEN),
       ("溫度衝擊", 3.6, 5.55, ORANGE), ("thermal shock", 5.0, 5.75, ORANGE)]
for lab, xx, yy, col in clu:
    chip(s, Inches(xx), Inches(yy), Inches(1.2), Inches(0.44), lab, col, sz=11.5)
box(s, Inches(8.5), Inches(2.25), Inches(4.13), Inches(4.3), fill=WHITE, line=LGRAY)
text(s, Inches(8.7), Inches(2.4), Inches(3.7), Inches(0.4), [[("這解決了什麼", 15, True, NAVY)]])
bullets(s, [(0, "「濕度」和「humidity」意思一樣 → 座標相鄰", DARK, False),
            (0, "用字不同也能被找到 → 不漏檢", DARK, False),
            (0, "鹽霧、溫度等不同主題自然分群 → 不混淆", DARK, False)],
        l=Inches(8.7), t=Inches(2.95), w=Inches(3.75), sz=13.5, gap=13)
box(s, Inches(8.7), Inches(5.3), Inches(3.75), Inches(1.05), fill=YELLOW, line=GOLD, line_w=1)
text(s, Inches(8.85), Inches(5.4), Inches(3.5), Inches(0.9),
     [[("💡 這就是「語意檢索」的底層:", 13, True, GOLD)], [("找的是意思,不是字面。", 13, True, DARK)]], anchor=MSO_ANCHOR.MIDDLE)
...
# +B · 切塊策略圖解
s = newslide("PART 2 · 把 RAG 做準", "技術細節①:切塊 — 「怎麼切」直接決定查得準不準")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.55),
     [[("文件要先切成小段才能檢索。切得好不好,決定 LLM 拿到的是完整條件、還是殘缺半句。", 15, False, DARK)]])
# left: 硬切
box(s, Inches(0.7), Inches(2.15), Inches(5.86), Inches(2.05), fill=LRED, line=RED, line_w=1.2)
text(s, Inches(0.9), Inches(2.28), Inches(5.5), Inches(0.4), [[("✗ 固定長度硬切:條件被切成兩半", 14.5, True, RED)]])
for i, (lab, col) in enumerate([("…停留至溫度", LGRAY), ("穩定後,維持…", LGRAY), ("(下一段)", LGRAY)]):
    b = box(s, Inches(0.95) + i * Inches(1.85), Inches(2.85), Inches(1.75), Inches(0.75), fill=WHITE, line=GRAY)
    tf = b.text_frame; tf.vertical_anchor = MSO_ANCHOR.MIDDLE
    p = tf.paragraphs[0]; p.alignment = PP_ALIGN.CENTER
    r = p.add_run(); r.text = lab; _set_font(r, 11, False, DARK)
text(s, Inches(0.95), Inches(3.7), Inches(5.4), Inches(0.4), [[("檢索只命中前半塊 → 答案漏掉「維持時間」", 12.5, True, RED)]])
# right: small-to-big
box(s, Inches(6.77), Inches(2.15), Inches(5.86), Inches(2.05), fill=LGREEN, line=GREEN, line_w=1.2)
text(s, Inches(6.97), Inches(2.28), Inches(5.5), Inches(0.4), [[("✓ Small-to-Big:小塊命中,大塊回答", 14.5, True, GREEN)]])
box(s, Inches(7.02), Inches(2.85), Inches(1.6), Inches(0.75), fill=GREEN)
text(s, Inches(7.02), Inches(2.85), Inches(1.6), Inches(0.75), [[("小塊\n精準命中", 11, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
arrow(s, Inches(8.75), Inches(3.0), Inches(0.5), Inches(0.45), color=GREEN)
box(s, Inches(9.4), Inches(2.75), Inches(3.1), Inches(0.95), fill=WHITE, line=GREEN, line_w=1.2)
text(s, Inches(9.4), Inches(2.75), Inches(3.1), Inches(0.95), [[("自動補回完整段落\n(停留 + 循環全帶上)", 11.5, True, DARK)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
text(s, Inches(6.97), Inches(3.7), Inches(5.4), Inches(0.4), [[("命中後往外擴 → LLM 拿到完整條件", 12.5, True, GREEN)]])
box(s, Inches(0.7), Inches(4.5), Inches(11.93), Inches(2.0), fill=BG, line=LGRAY)
text(s, Inches(0.95), Inches(4.62), Inches(11.5), Inches(0.4), [[("兩個要調的旋鈕:", 15, True, NAVY)]])
bullets(s, [(0, "區塊大小(Chunk size):太大 → 一塊混很多主題,檢索抓不準;太小 → 條件被切斷", DARK, False),
            (0, "重疊(Overlap):相鄰塊留一點重疊,避免剛好切在關鍵句中間", DARK, False),
            (0, "Small-to-Big:用小塊命中換「精準」,再擴回大塊換「完整」,兩者兼得", NAVY, True)],
        l=Inches(1.0), t=Inches(5.05), w=Inches(11.3), sz=14, gap=8)

# +C · 兩段式檢索漏斗
s = newslide("PART 2 · 把 RAG 做準", "技術細節②:兩段式檢索 — 先廣撒網,再精挑細選")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.55),
     [[("一次到位既慢又不準。本系統分兩段:向量檢索負責「快、找得到」,重排負責「準、排得對」。", 15, False, DARK)]])
# funnel
stages = [("全部文件片段", "數萬段", NAVY, 3.0), ("向量檢索\n(Bi-Encoder,快)", "撈回 Top-20", BLUE, 2.5), ("重排\n(Cross-Encoder,準)", "精選 Top-5", TEAL, 2.0), ("送進 LLM\n生成答案", "最相關 5 段", PURPLE, 1.6)]
x = Inches(0.75); y = Inches(2.55); bw = Inches(2.7)
for i, (lab, sub, col, hh) in enumerate(stages):
    bx = x + i * (bw + Inches(0.32))
    h = Inches(hh)
    b = box(s, bx, y + (Inches(3.2) - h) // 2, bw, h, fill=col, shape=MSO_SHAPE.ROUNDED_RECTANGLE)
    tf = b.text_frame; tf.vertical_anchor = MSO_ANCHOR.MIDDLE; tf.word_wrap = True
    lines = lab.split("\n")
    for j, ln in enumerate(lines):
        p = tf.paragraphs[0] if j == 0 else tf.add_paragraph(); p.alignment = PP_ALIGN.CENTER
        r = p.add_run(); r.text = ln; _set_font(r, 13.5, True, WHITE)
    p2 = tf.add_paragraph(); p2.alignment = PP_ALIGN.CENTER; p2.space_before = Pt(3)
    r2 = p2.add_run(); r2.text = "▸ " + sub; _set_font(r2, 12, True, RGBColor(0xFF, 0xE0, 0x66))
    if i < 3:
        arrow(s, bx + bw + Emu(15000), y + Inches(1.5), Inches(0.3), Inches(0.28), color=GRAY)
box(s, Inches(0.7), Inches(5.35), Inches(5.86), Inches(1.15), fill=LBLUE, line=BLUE, line_w=1)
text(s, Inches(0.9), Inches(5.45), Inches(5.5), Inches(0.95),
     [[("向量檢索(Bi-Encoder)", 13.5, True, BLUE)], [("各段先各自算好座標,比對快 → 適合從海量中粗篩。", 12.5, False, DARK)]])
box(s, Inches(6.77), Inches(5.35), Inches(5.86), Inches(1.15), fill=LGREEN, line=GREEN, line_w=1)
text(s, Inches(6.97), Inches(5.45), Inches(5.5), Inches(0.95),
     [[("重排(Cross-Encoder)", 13.5, True, GREEN)], [("把問題和每段「一起」精算相關度,準 → 適合對少量精排。", 12.5, False, DARK)]])
...
# +D · KG 是自動建出來的
s = newslide("PART 3 · 知識圖譜", "澄清一個誤會:這張圖是「自動長出來」的,不是人工畫")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.55),
     [[("很多人以為知識圖譜要靠人手動建。其實每匯入一份規範,系統就自動抽取、自動連線。", 15, False, DARK)]])
kg_steps = [("① 讀文件", "抽取每一段文字", NAVY),
            ("② 認出規範編號", "用規則找出\nMIL-STD / IEC / ASTM…", BLUE),
            ("③ 判斷關係", "由 LLM 判斷兩份規範是\n引用?取代?要求?", ORANGE),
            ("④ 存成連線", "寫入圖譜,設信心門檻\n過濾雜訊", GREEN)]
x = Inches(0.7); y = Inches(2.35); bw = Inches(2.83); bh = Inches(1.9); g = Inches(0.2)
for i, (h, d, col) in enumerate(kg_steps):
    bx = x + i * (bw + g)
    box(s, bx, y, bw, bh, fill=WHITE, line=LGRAY, line_w=1.2)
    box(s, bx, y, bw, Inches(0.6), fill=col)
    text(s, bx, y + Inches(0.1), bw, Inches(0.42), [[(h, 15, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
    text(s, bx + Inches(0.15), y + Inches(0.75), bw - Inches(0.3), Inches(1.05), [[(d, 12.5, False, DARK)]], align=PP_ALIGN.CENTER)
    if i < 3:
        arrow(s, bx + bw + Emu(6000), y + bh // 2 - Inches(0.1), g - Emu(12000), Inches(0.2), color=GRAY)
box(s, Inches(0.7), Inches(4.6), Inches(11.93), Inches(1.9), fill=BG, line=LGRAY)
text(s, Inches(0.95), Inches(4.72), Inches(11.5), Inches(0.4), [[("兩個設計重點,讓自動抽取「不亂長」:", 15, True, NAVY)]])
bullets(s, [(0, "封閉關係詞彙:只認 5 種關係 — 引用 / 取代 / 要求 / 定義 / 衍生自,不讓 LLM 自由發揮", DARK, False),
            (0, "信心門檻:LLM 判斷關係時附信心值,低於門檻直接丟掉 → 寧缺勿濫", DARK, False),
            (0, "結果:目前 4,979 條關係全自動產生,新增文件即自動接上既有節點", NAVY, True)],
        l=Inches(1.0), t=Inches(5.15), w=Inches(11.3), sz=14, gap=8)

# +E · 版本鏈追查
s = newslide("PART 3 · 知識圖譜", "KG 的獨門本事:沿「版本鏈」追到該用哪一版")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.55),
     [[("規範常有 A/B/C 多版,用錯版本是常見事故。圖譜把「取代」關係也連起來,一問就知道。", 15, False, DARK)]])
c1 = node(Inches(1.0), Inches(3.05), "IEC 60068-2-52\n(舊版)", GRAY, w=Inches(2.5), h=Inches(1.0))
c2 = node(Inches(5.1), Inches(3.05), "IEC 60068-2-68\n(現行)", GREEN, w=Inches(2.5), h=Inches(1.0))
c3 = node(Inches(9.1), Inches(3.05), "Method 510.7\n沙塵測試", ORANGE, w=Inches(2.5), h=Inches(1.0))
edge(*c1, *c2, "取代", RED)
edge(*c3, *c2, "引用", BLUE)
text(s, Inches(0.7), Inches(4.55), Inches(11.93), Inches(0.9),
     [[("讀法:「510.7 引用的是 IEC 60068-2-68,而它取代了舊的 60068-2-52 → 該用 68,不是 52。」", 15, True, NAVY)]])
box(s, Inches(0.7), Inches(5.45), Inches(11.93), Inches(1.05), fill=YELLOW, line=GOLD, line_w=1)
text(s, Inches(0.95), Inches(5.55), Inches(11.5), Inches(0.9),
     [[("💡 純 RAG 只讀某一段文字,看不到版本先後;KG 有「取代」這條線(全庫共 43 條),才追得出版本鏈。", 14.5, True, DARK)]], anchor=MSO_ANCHOR.MIDDLE)
...
# =====================================================================
# Part 4 divider (系統實作與維運)
# =====================================================================
section("PART 4", "系統實作與維運", "從匯入、解析、分析到維運,一套流程走完")

# 23 · 系統功能一覽 + 設定
s = newslide("PART 4 · 系統實作", "一套系統,涵蓋匯入 → 問答 → 圖譜 → 設定全流程")
...
# +F · 文件匯入流程
s = newslide("PART 4 · 系統實作", "文件匯入:上傳 → 解析 → 向量化")
place_img(s, os.path.join(DECK, "05_documents.png"), Inches(0.5), Inches(1.5), Inches(6.1), Inches(4.4))
place_img(s, os.path.join(DECK, "06_doc_new.png"), Inches(6.85), Inches(1.5), Inches(5.9), Inches(4.4))
text(s, Inches(0.5), Inches(5.95), Inches(6.1), Inches(0.35), [[("① 文件列表:已匯入 40 份規範,可檢視 / 下載", 12.5, True, BLUE)]], align=PP_ALIGN.CENTER)
text(s, Inches(6.85), Inches(5.95), Inches(5.9), Inches(0.35), [[("② 建立文件:上傳 PDF → 解析 → 自動向量化", 12.5, True, GREEN)]], align=PP_ALIGN.CENTER)
box(s, Inches(0.7), Inches(6.4), Inches(11.93), Inches(0.6), fill=BG, line=LGRAY)
text(s, Inches(0.95), Inches(6.44), Inches(11.5), Inches(0.52),
     [[("匯入後,系統自動切塊、向量化、並排入知識圖譜抽取佇列 — 使用者只要上傳,其餘全自動。", 13.5, True, NAVY)]], anchor=MSO_ANCHOR.MIDDLE)

# +G · 掃描件 OCR
s = newslide("PART 4 · 系統實作", "掃描件也能處理:OCR 自動辨識")
text(s, Inches(0.7), Inches(1.45), Inches(12), Inches(0.6),
     [[("不少軍規是「掃描成圖片的 PDF」— 沒有文字層,一般工具讀不到。系統偵測後自動走 OCR。", 15.5, False, DARK)]])
box(s, Inches(0.7), Inches(2.4), Inches(5.86), Inches(3.6), fill=WHITE, line=LGRAY, line_w=1.2)
box(s, Inches(0.7), Inches(2.4), Inches(5.86), Inches(0.7), fill=BLUE)
text(s, Inches(0.9), Inches(2.5), Inches(5.5), Inches(0.5), [[("兩種文件,兩條路", 17, True, WHITE)]], anchor=MSO_ANCHOR.MIDDLE)
bullets(s, [(0, "原生 PDF(有文字層)→ 直接抽文字,快", DARK, False),
            (0, "掃描 PDF(純圖片)→ 自動 OCR 辨識成文字", DARK, False),
            (0, "圖表多的頁面 → 可用視覺模型(Vision)理解", DARK, False),
            (0, "使用者可手動勾選「強制 OCR」處理疑難件", NAVY, True)],
        l=Inches(1.0), t=Inches(3.3), w=Inches(5.3), sz=14.5, gap=14)
box(s, Inches(6.77), Inches(2.4), Inches(5.86), Inches(3.6), fill=LGREEN, line=GREEN, line_w=1.2)
text(s, Inches(6.97), Inches(2.55), Inches(5.5), Inches(0.5), [[("為什麼重要", 17, True, GREEN)]])
bullets(s, [(0, "軍規/舊標準常是掃描檔,沒 OCR 就完全查不到", DARK, False),
            (0, "OCR 讓「圖片裡的規範」也能被語意檢索", DARK, False),
            (0, "實測:曾有掃描件原本只切出 1 段,強制 OCR 後正確切出數十段", DARK, False),
            (0, "→ 收錄範圍不再受文件格式限制", GREEN, True)],
        l=Inches(7.07), t=Inches(3.3), w=Inches(5.3), sz=14, gap=12)

# +H · 跨頁 AI 分析
s = newslide("PART 4 · 系統實作", "跨頁 AI 分析:一次讀多頁,抓出跨頁重點")
text(s, Inches(0.7), Inches(1.45), Inches(12), Inches(0.6),
     [[("有些答案要「橫跨好幾頁」才看得懂。系統可在 PDF 預覽頁一次框選多頁,交給視覺模型整合分析。", 15.5, False, DARK)]])
# flow: pages -> VL -> summary
pgs = ["p.263", "p.264", "…", "p.272"]
for i, pg in enumerate(pgs):
    b = box(s, Inches(0.9) + i * Inches(0.95), Inches(2.7), Inches(0.8), Inches(1.05), fill=WHITE, line=BLUE, line_w=1.3, shape=MSO_SHAPE.ROUNDED_RECTANGLE)
    tf = b.text_frame; tf.vertical_anchor = MSO_ANCHOR.MIDDLE
    p = tf.paragraphs[0]; p.alignment = PP_ALIGN.CENTER
    r = p.add_run(); r.text = pg; _set_font(r, 12, True, BLUE)
arrow(s, Inches(4.85), Inches(3.05), Inches(0.6), Inches(0.35), color=GRAY)
box(s, Inches(5.6), Inches(2.6), Inches(2.7), Inches(1.25), fill=PURPLE, shape=MSO_SHAPE.ROUNDED_RECTANGLE)
text(s, Inches(5.6), Inches(2.6), Inches(2.7), Inches(1.25), [[("視覺模型(VL)\n一次讀完多頁", 14, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
arrow(s, Inches(8.45), Inches(3.05), Inches(0.6), Inches(0.35), color=GRAY)
box(s, Inches(9.2), Inches(2.6), Inches(3.4), Inches(1.25), fill=GREEN, shape=MSO_SHAPE.ROUNDED_RECTANGLE)
text(s, Inches(9.2), Inches(2.6), Inches(3.4), Inches(1.25), [[("整合摘要\n含跨頁關聯", 14, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
box(s, Inches(0.7), Inches(4.35), Inches(11.93), Inches(2.15), fill=BG, line=LGRAY)
text(s, Inches(0.95), Inches(4.48), Inches(11.5), Inches(0.4), [[("已實測驗證:", 15, True, NAVY)]])
bullets(s, [(0, "連續 10 頁測試 → 系統逐頁列出每頁重點,再給一段跨頁總結", DARK, False),
            (0, "確認輸出「真的包含跨頁關聯」,不是單頁拼貼", DARK, False),
            (0, "為兼顧模型負載,單次分析上限設為 10 頁(可依需求調整)", DARK, False),
            (0, "適合:一個測試程序橫跨數頁時,快速掌握全貌", NAVY, True)],
        l=Inches(1.0), t=Inches(4.9), w=Inches(11.3), sz=14, gap=8)

# +I · 維運可靠性
s = newslide("PART 4 · 系統實作", "維運可靠性:檢索測試 + 向量庫健康檢查")
place_img(s, os.path.join(DECK, "07_vector_search.png"), Inches(0.5), Inches(1.55), Inches(6.1), Inches(4.2))
place_img(s, os.path.join(DECK, "08_vector_health.png"), Inches(6.85), Inches(1.55), Inches(5.9), Inches(4.2))
text(s, Inches(0.5), Inches(5.8), Inches(6.1), Inches(0.35), [[("⑦ 向量查詢測試:直接檢驗檢索品質", 12.5, True, ORANGE)]], align=PP_ALIGN.CENTER)
text(s, Inches(6.85), Inches(5.8), Inches(5.9), Inches(0.35), [[("⑧ 向量庫健康:資料庫與索引一致性", 12.5, True, GREEN)]], align=PP_ALIGN.CENTER)
box(s, Inches(0.7), Inches(6.25), Inches(11.93), Inches(0.72), fill=NAVY)
text(s, Inches(0.95), Inches(6.29), Inches(11.5), Inches(0.64),
     [[("這兩個工具讓管理者隨時確認「系統還準不準、資料有沒有掉」— 是能長期營運、可被信任的關鍵。", 14.5, True, WHITE)]], anchor=MSO_ANCHOR.MIDDLE)

# +K · 技術架構總覽
s = newslide("PART 4 · 系統實作", "系統架構總覽:全地端、可離線運行")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.5),
     [[("整套系統可部署在公司內部機器,不依賴外部雲端 API — 資料不出門。", 15, False, DARK)]])
# layers
box(s, Inches(2.5), Inches(2.1), Inches(8.3), Inches(0.75), fill=NAVY, shape=MSO_SHAPE.ROUNDED_RECTANGLE)
text(s, Inches(2.5), Inches(2.1), Inches(8.3), Inches(0.75), [[("前端  React + Ant Design(瀏覽器操作介面)", 15, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
arrow(s, Inches(6.45), Inches(2.9), Inches(0.4), Inches(0.3), color=GRAY)
box(s, Inches(2.5), Inches(3.3), Inches(8.3), Inches(0.75), fill=BLUE, shape=MSO_SHAPE.ROUNDED_RECTANGLE)
text(s, Inches(2.5), Inches(3.3), Inches(8.3), Inches(0.75), [[("後端  FastAPI(RAG / KG / Agent 邏輯)", 15, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
comps = [("Ollama", "LLM / 向量 / 視覺\n模型(地端)", TEAL), ("FAISS", "向量索引庫\n(語意檢索)", ORANGE),
         ("SQLite", "文件 / 對話\n資料庫", PURPLE), ("知識圖譜", "規範關係\n節點與連線", GREEN)]
cw = Inches(1.95); x0 = Inches(2.5); y0 = Inches(4.55)
for i, (h, d, col) in enumerate(comps):
    cx = x0 + i * (cw + Inches(0.15))
    box(s, cx, y0, cw, Inches(1.35), fill=WHITE, line=col, line_w=1.5)
    box(s, cx, y0, cw, Inches(0.5), fill=col)
    text(s, cx, y0 + Inches(0.06), cw, Inches(0.4), [[(h, 14, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
    text(s, cx + Inches(0.08), y0 + Inches(0.58), cw - Inches(0.16), Inches(0.72), [[(d, 11.5, False, DARK)]], align=PP_ALIGN.CENTER)
box(s, Inches(0.7), Inches(6.3), Inches(11.93), Inches(0.68), fill=YELLOW, line=GOLD, line_w=1)
text(s, Inches(0.95), Inches(6.34), Inches(11.5), Inches(0.6),
     [[("💡 模型(Ollama)跑在自家機器 → 私有規範與查詢內容全程不外流,符合軍工/資安要求。", 14.5, True, DARK)]], anchor=MSO_ANCHOR.MIDDLE)

# =====================================================================
# Part 4 divider
# =====================================================================
section("PART 5", "成果與未來", "AS-IS / TO-BE · 為何適合測試規範 · 下一步")

# 24 · AS-IS / TO-BE
s = newslide("PART 5 · 成果", "AS-IS vs TO-BE:同樣的問題,兩種結果")
rows = [
...
# +L · 導入效益 ROI
s = newslide("PART 5 · 成果", "導入效益:把工程師的時間,還給工程師")
text(s, Inches(0.7), Inches(1.4), Inches(12), Inches(0.5),
     [[("以下為導入效益的方向與示意(實際數字依規範量與使用情境而定):", 14.5, False, GRAY)]])
roi = [("查一條規範條件", "數十分鐘翻頁", "數秒問答", BLUE),
       ("跨規範追引用", "人工逐份、易漏", "一次到齊、可驗證", GREEN),
       ("新人上手", "數週熟悉文件", "當天就能問", ORANGE),
       ("答案稽核", "翻檔逐字比對", "一鍵回到 PDF 頁", PURPLE)]
x0 = Inches(0.7); y0 = Inches(2.15); cw = Inches(2.9); ch = Inches(3.0); gx = Inches(0.16)
for i, (h, a, b, col) in enumerate(roi):
    cx = x0 + i * (cw + gx)
    box(s, cx, y0, cw, ch, fill=WHITE, line=LGRAY, line_w=1.2)
    box(s, cx, y0, cw, Inches(0.7), fill=col)
    text(s, cx, y0 + Inches(0.12), cw, Inches(0.46), [[(h, 14.5, True, WHITE)]], align=PP_ALIGN.CENTER, anchor=MSO_ANCHOR.MIDDLE)
    text(s, cx + Inches(0.15), y0 + Inches(0.95), cw - Inches(0.3), Inches(0.5), [[("今天", 12, True, GRAY)]], align=PP_ALIGN.CENTER)
    text(s, cx + Inches(0.15), y0 + Inches(1.35), cw - Inches(0.3), Inches(0.5), [[(a, 13.5, False, DARK)]], align=PP_ALIGN.CENTER)
    text(s, cx, y0 + Inches(1.9), cw, Inches(0.35), [[("▼", 14, True, col)]], align=PP_ALIGN.CENTER)
    text(s, cx + Inches(0.15), y0 + Inches(2.35), cw - Inches(0.3), Inches(0.5), [[(b, 14, True, col)]], align=PP_ALIGN.CENTER)
box(s, Inches(0.7), Inches(5.55), Inches(11.93), Inches(0.9), fill=NAVY)
text(s, Inches(0.95), Inches(5.6), Inches(11.5), Inches(0.8),
     [[("核心效益不只是「快」,而是「一致、可查證、不因人而異」— 把老師傅的經驗,變成全公司都能用的知識庫。", 15.5, True, WHITE)]], anchor=MSO_ANCHOR.MIDDLE)

# +M · 資安與合規
s = newslide("PART 5 · 成果", "資安與合規:資料不出門、版權有界線")
cards = [("🔒 地端部署", "模型與資料庫都跑在自家機器,私有規範與查詢內容全程不上外部雲端 — 符合軍工/資安要求。", BLUE),
         ("⚖️ 版權界線", "只收錄公開可取得的標準(如公開 MIL / 政府文件);付費規範(ASTM / IEC 全文)不收錄,避免版權爭議。", ORANGE),
         ("👤 權限與紀錄", "查詢與對話按使用者分離、可留存紀錄 — 誰查了什麼、答案出自哪,都可追溯。", GREEN)]
x0 = Inches(0.7); y0 = Inches(1.7); cw = Inches(3.95); gap = Inches(0.25)
for i, (h, b, col) in enumerate(cards):
    cx = x0 + i * (cw + gap)
    box(s, cx, y0, cw, Inches(3.7), fill=WHITE, line=LGRAY, line_w=1.2)
    box(s, cx, y0, cw, Pt(7), fill=col)
    text(s, cx + Inches(0.25), y0 + Inches(0.3), cw - Inches(0.5), Inches(0.55), [[(h, 18, True, col)]])
    text(s, cx + Inches(0.3), y0 + Inches(1.05), cw - Inches(0.6), Inches(2.4), [[(b, 14.5, False, DARK)]])
box(s, Inches(0.7), Inches(5.75), Inches(11.93), Inches(0.8), fill=YELLOW, line=GOLD, line_w=1)
text(s, Inches(0.95), Inches(5.8), Inches(11.5), Inches(0.7),
     [[("💡 對軍規測試這種敏感領域,「資料主權」和「版權合規」和查得準一樣重要 — 這是設計時就守住的底線。", 14.5, True, DARK)]], anchor=MSO_ANCHOR.MIDDLE)

# 25 · 為何測試規範是最佳場景
s = newslide("PART 5 · 為什麼是測試規範", "為什麼「測試規範」是 RAG × KG 的最佳落地場景")
...
# 26 · 未來:輸入全部規範
s = newslide("PART 5 · 未來展望", "下一步之一:把「全部規範」都收進來")
text(s, Inches(0.7), Inches(1.45), Inches(12), Inches(0.6),
...
# 27 · 非規範文件相容性
s = newslide("PART 5 · 未來展望", "下一步之二:對「非規範文件」也相容")
text(s, Inches(0.7), Inches(1.45), Inches(12), Inches(0.6),
...
# +N · 導入路線圖
s = newslide("PART 5 · 未來展望", "導入路線圖:分階段長成一座活知識庫")
phases = [("現況", "已完成", "40 份軍規文件\n+ 自動知識圖譜\n+ 混合查詢上線", GREEN),
          ("短期", "3–6 個月", "補齊常用規範全套\n擴充版本鏈\n收斂常見問法", BLUE),
          ("中期", "6–12 個月", "納入非規範文件\n(測試報告 / SOP)\n權限分級管理", ORANGE),
          ("長期", "1 年以上", "全標準知識庫\n接入現有流程系統\n持續擴充節點網", PURPLE)]
x0 = Inches(0.7); y0 = Inches(2.0); cw = Inches(2.9); gx = Inches(0.16)
# baseline
box(s, Inches(0.7), Inches(1.85), Inches(11.93), Pt(4), fill=NAVY)
for i, (h, when, d, col) in enumerate(phases):
    cx = x0 + i * (cw + gx)
    box(s, cx + cw // 2 - Inches(0.11), Inches(1.72), Inches(0.22), Inches(0.22), fill=col, shape=MSO_SHAPE.OVAL)
    box(s, cx, y0 + Inches(0.25), cw, Inches(3.9), fill=WHITE, line=LGRAY, line_w=1.2)
    box(s, cx, y0 + Inches(0.25), cw, Inches(0.85), fill=col)
    text(s, cx, y0 + Inches(0.32), cw, Inches(0.42), [[(h, 18, True, WHITE)]], align=PP_ALIGN.CENTER)
    text(s, cx, y0 + Inches(0.72), cw, Inches(0.34), [[(when, 12.5, True, WHITE)]], align=PP_ALIGN.CENTER)
    text(s, cx + Inches(0.2), y0 + Inches(1.3), cw - Inches(0.4), Inches(2.6), [[(d, 14, False, DARK)]], align=PP_ALIGN.CENTER)
text(s, Inches(0.7), Inches(6.45), Inches(11.93), Inches(0.5),
     [[("越往後,累積的節點與關係越多,知識庫的價值越高 — 這是一次投資、長期複利的資產。", 14.5, True, NAVY)]], align=PP_ALIGN.CENTER)

# +Q · 誠實面:已知限制與邊界
s = newslide("PART 5 · 未來展望", "誠實面:目前已知的限制與邊界")
text(s, Inches(0.7), Inches(1.45), Inches(12), Inches(0.55),
     [[("把限制講清楚,才知道怎麼用、往哪補。以下是目前的邊界與對應做法:", 15.5, False, DARK)]])
lims = [("付費規範只放摘要", "ASTM / IEC 全文有版權,館內僅收錄公開標準;遇到會明確指出「未收錄」,不亂編。", ORANGE),
        ("跨頁分析有頁數上限", "單次視覺分析上限 10 頁(顧及模型負載);超大範圍需分批,數字可依算力調整。", BLUE),
        ("關係靠 LLM 判斷", "自動抽取的關係設有信心門檻過濾;仍可能有極少數誤判 → 保留人工複核機制。", PURPLE),
        ("需要地端算力", "模型跑在本機,需一定 GPU/記憶體;換取的是資料不外流與長期零 API 成本。", GREEN)]
x0 = Inches(0.7); y0 = Inches(2.2); cw = Inches(5.86); ch = Inches(1.9); gx = Inches(0.21); gy = Inches(0.25)
for i, (h, b, col) in enumerate(lims):
    r, c = divmod(i, 2)
    cx = x0 + c * (cw + gx); cy = y0 + r * (ch + gy)
    box(s, cx, cy, cw, ch, fill=WHITE, line=LGRAY, line_w=1.2)
    box(s, cx, cy, Pt(7), ch, fill=col)
    text(s, cx + Inches(0.3), cy + Inches(0.22), cw - Inches(0.5), Inches(0.5), [[("• " + h, 16, True, col)]])
    text(s, cx + Inches(0.35), cy + Inches(0.82), cw - Inches(0.6), Inches(1.0), [[(b, 13.5, False, DARK)]])
box(s, Inches(0.7), Inches(6.4), Inches(11.93), Inches(0.6), fill=NAVY)
text(s, Inches(0.95), Inches(6.44), Inches(11.5), Inches(0.52),
     [[("每一項限制都有對應做法或調整空間 — 沒有黑箱,可控、可規劃。", 14.5, True, WHITE)]], anchor=MSO_ANCHOR.MIDDLE)
